...
module.exports = {
    ...
    aliases: ["catgirl"],
    category: "anime",
    description: "Posts a random Neko\n\n",
    usage: "`&neko` - You can tick the :star: reaction to save results to your Personal Gallery",
    run: async (bot, msg, args) => {

        fetch("https://waifu.pics/api/sfw/neko").then(async res => res.json()).then(async body => {
            if (!body) {
